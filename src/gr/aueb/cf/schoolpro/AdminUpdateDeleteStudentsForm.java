...
public class AdminUpdateDeleteStudentsForm extends JFrame {
	...
	public AdminUpdateDeleteStudentsForm() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				try {
					...
					if (!rs.next()) {
						JOptionPane.showMessageDialog(null, "No students found", "Result", JOptionPane.INFORMATION_MESSAGE);
		...
		udpateBtn.setBounds(115, 441, 90, 45);
		...
		deleteBtn.setBounds(210, 441, 90, 45);
		...
		closeBtn.setBounds(304, 441, 90, 45);
