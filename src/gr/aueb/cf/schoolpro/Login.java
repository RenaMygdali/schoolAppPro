...
//		});
		...
		loginBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//if (usernameTxt.getText().matches(Role.Admin.name())) {
					if (inputPassword.equals(System.getenv("schoolDBPro_USER_PASSWD"))) {
		...
		confirmPassRegLbl.setFont(new Font("Tahoma", Font.BOLD, 14));
		confirmPassRegLbl.setBounds(44, 110, 128, 23);
		...
		confirmPassRegTxt.setBounds(182, 110, 153, 23);
		...
		registerBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String password2 = String.valueOf(confirmPassRegTxt.getPassword()).trim();
...
//				}
				...
				try (Connection connection = DBUtil.getConnection();
					...
					ps.setString(3, role);
					ps.executeUpdate();
					JOptionPane.showMessageDialog(null,  "Registration completed", "REGISTRATION", JOptionPane.INFORMATION_MESSAGE);
