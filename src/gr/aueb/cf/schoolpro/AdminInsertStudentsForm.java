		...
		insertBtn.addActionListener(new ActionListener()  {
			public void actionPerformed(ActionEvent e) {
				...
				try (Connection conn = DBUtil.getConnection();) {
					...
					e1.printStackTrace();
//					JOptionPane.showMessageDialog(null, "Error executing SQL: " + e1.getMessage(), "SQL Error", JOptionPane.ERROR_MESSAGE);
				} finally {
					try {
						if (ps != null) ps.close();
...
//				System.out.println(usernameComboBox.getSelectedItem() + ", id: " + usernames.get(usernameComboBox.getSelectedItem()));
		...
		insertBtn.setBounds(240, 245, 108, 47);
		...
		closeBtn.setBounds(377, 245, 108, 47);
